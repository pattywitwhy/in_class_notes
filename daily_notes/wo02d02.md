...
Models are a class that talks to a database.
...
Notice that it's filling in the ids for you as you go along. Hooray. I cleaned this up, but note that this is actually returned as an array of recipes. 
